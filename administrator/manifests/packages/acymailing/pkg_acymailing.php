...
class Pkg_AcymailingInstallerScript extends InstallerScript
{
    public function preflight($type, $parent)
    {
        ...
        if (version_compare(PHP_VERSION, '7.2.0', '<')) {
            echo '<p style="color:red">This version of AcyMailing requires at least PHP 7.2.0, please upgrade your server\'s PHP version!</p>';
        ...
        if (version_compare($jversion, '3.0.0', '<')) {
            echo '<p style="color:red">This version of AcyMailing requires at least Joomla 3, please upgrade your website first!</p>';
    ...
    private function addUpdateSite(): void
    {
        ...
        $updateSiteDefinition->location = ACYM_UPDATEME_API_URL.'public/updatexml/component?extension=acymailing&cms=joomla&version=latest&level=starter&type=package';
