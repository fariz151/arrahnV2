...
namespace PluginsWare\Component\YendifVideoShare\Administrator\View\Category;
...
class HtmlView extends BaseHtmlView {
	...
	protected function addToolbar()	{
		...
		$title = $isNew ? Text::sprintf( 'COM_YENDIFVIDEOSHARE_CATEGORY_ADD_TITLE', $componentName ) : Text::sprintf( 'COM_YENDIFVIDEOSHARE_CATEGORY_EDIT_TITLE', $componentName );
