...
<form action="<?php echo Route::_( 'index.php?option=com_yendifvideoshare&view=ratings' ); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
						...
						<thead>
							<tr>
								...
								<th class="text-center">
									<?php echo HTMLHelper::_( 'searchtools.sort',  'COM_YENDIFVIDEOSHARE_TITLE_RATINGS', 'a.rating', $listDirn, $listOrder ); ?>
								</th>
