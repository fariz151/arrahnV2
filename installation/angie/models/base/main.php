...
abstract class AngieModelBaseMain extends AModel
{
	...
	/**
	 * Get the contents of the extrainfo.json file as a simple PHP object
	 *
	 * @return  object
	 * @since   9.8.1
	 */
	public function getExtraInfoObject()
	{
		static $extraInfoObject = null;

		if ($extraInfoObject === null)
		{
			$extraInfoObject = new stdClass();
			...
			try
			{
				$parsedData = json_decode($raw_data === false ? '{}' : $raw_data, false);
			}
			catch (Exception $e)
			{
				$parsedData = null;
			...
			$extraInfoObject = $parsedData === null ? $extraInfoObject : $parsedData;
		}
