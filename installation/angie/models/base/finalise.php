...
class AngieModelBaseFinalise extends AModel
{
	public function cleanup()
	{
		...
		$files_map = array(
			$publicFolder . '/htaccess.bak'	=> $publicFolder . '/.htaccess',
			$publicFolder . '/web.config.bak'	=> $publicFolder . '/web.config',
			$publicFolder . '/php.ini.bak'		=> $publicFolder . '/php.ini',
		);
        ...
        if (file_exists($publicFolder.'/kickstart.php'))
        {
            @unlink($publicFolder.'/kickstart.php');
        }
