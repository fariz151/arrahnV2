...
<form name="setupForm" action="index.php" method="post" class="akeeba-form--horizontal">
	...
	<div class="akeeba-container--50-50">
		...
		<div class="akeeba-panel--teal" style="margin-top: 0">
			...
			<?php
			$langKeySuffix = version_compare($this->container->session->get('jversion', '2.5.0'), '5.1.0', 'ge') ? '_51' : '';
			?>
			...
			<div class="akeeba-form-group--pull-right">
				<button type="button"
					...
					<?php echo AText::_('SETUP_LBL_USESITEDIRS' . $langKeySuffix); ?>
				</button>
				<span class="akeeba-help-text" style="display: none">
					  <?php echo AText::_('SETUP_LBL_USESITEDIRS_HELP' . $langKeySuffix) ?>
				</span>
			</div>
		</div>
	...
	<div class="akeeba-container--50-50">
		...
		<div class="akeeba-panel--info" style="margin-top: 0">
			...
			<div class="form-horizontal">
				...
				<div class="akeeba-form-group">
					<label for="cache_path">
						<?php echo AText::_('SETUP_LBL_CACHE_PATH'); ?>
					</label>
					<input type="text" id="cache_path" name="cache_path"
						   value="<?php echo is_null($this->stateVars->cache_path) ? '' : $this->stateVars->cache_path ?>" />
					<span class="akeeba-help-text" style="display: none">
						<?php echo AText::_('SETUP_LBL_CACHE_PATH_HELP') ?>
					</span>
				</div>
				<?php else: ?>
