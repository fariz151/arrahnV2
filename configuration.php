...
class JConfig
{
	...
	public $force_ssl = '0';
	public $fromname = 'Himax Joomla Business Template';
	...
	public $log_path = 'C:/wamp64/www/himax/administrator/logs';
	public $log_priorities = array (
'0' => 'all'
);
	public $mailer = 'mail';
	public $mailfrom = 'mail@example.com';
	public $mailonline = '1';
	...
	public $replytoname = '';
	public $robots = '';
	public $secret = 'QSkS46PQR9vE6Z0BmaU2QI9qzF6l3VjB';
	public $sef = true;
	...
	public $sitename = 'Himax Joomla Business and Finance Template';
	...
	public $smtpuser = '';
	public $tmp_path = 'C:/wamp64/www/himax/tmp';
