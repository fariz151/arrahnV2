...
?><div class="t4-breadcrumbs-inner  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s">
<div class="container breadcrumbs-wrap-himax">
<div class="breadcrumbs-left"> <?php
        ...
        foreach ($list as $key => $item) :
            ...
            elseif ($show_last) :
                ...
                $breadcrumbItem = '<span>' . $item->name . '</span>';
                $class          = ' active';
                echo '<h3 class="mod-breadcrumbs__item breadcrumb-item lastword' . $class . '">' . $breadcrumbItem . '</h3>';
            endif;
        endforeach; ?></div>
<div class="breadcrumbs-right"><nav class="mod-breadcrumbs__wrapper" aria-label="<?php echo htmlspecialchars($module->title, ENT_QUOTES, 'UTF-8'); ?>">
    <ol class="mod-breadcrumbs himax breadcrumb">
