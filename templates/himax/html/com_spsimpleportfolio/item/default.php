...
<div id="sp-simpleportfolio" class="sp-simpleportfolio himax sp-simpleportfolio-view-item">
<div class="row">
	<div class="sp-simpleportfolio-image col-sm-7">
	...
	<div class="sp-simpleportfolio-details col-sm-5 clearfix">
		<div class="sp-simpleportfolio-description himax">
			<h2><?php echo $this->item->title; ?></h2>
			<?php echo HTMLHelper::_('content.prepare', $this->item->description); ?>
		</div>

		<div class="sp-simpleportfolio-meta himax">
