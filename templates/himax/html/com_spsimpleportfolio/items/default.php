...
<div id="sp-simpleportfolio" class="sp-simpleportfolio himax sp-simpleportfolio-view-items layout-<?php echo $this->layout_type; ?>">
	...
	<?php if (!empty($this->items)) : ?>
		<div class="sp-simpleportfolio-items sp-simpleportfolio-columns-<?php echo $this->params->get('columns', 3); ?>">
			<?php foreach ($this->items as $this->item) : ?>
				<div class="sp-simpleportfolio-item wow zoomIn" data-wow-duration="1s" data-wow-delay="0.<?php echo $key; ?>s" data-groups='[<?php echo $this->item->groups; ?>]'>
				<div class="box-shadow border-rad5" >
