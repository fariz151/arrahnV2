...
?>
<div class="jtcs_item_wrapper jt-cs himax ourservices" style="padding:<?php echo $params->get('content_padding');?>;">
...
<?php 
	...
	foreach ($list as $i =>  $item) : 
		// Check whether thumbnail image is exist or not. If it's not then start thumbnail generation process
			...
			?>
			 <div class="slide box-shadow brad-10 wow fadeInUp" data-wow-duration="1s" data-wow-delay="<?php $increment = 0.2; echo (0.1 + ($i * $increment)); ?>s" style="padding:<?php echo $params->get('article_block_padding');?>;margin:<?php echo $params->get('article_block_margin');?>"  data-slide-index="<?php echo $i; ?>">
			  <div class="jt-inner">
